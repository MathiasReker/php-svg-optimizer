...
final class SortAttributesTest extends TestCase
{
    ...
    {
        yield 'Sorts Attributes in Correct Order' => [<<<'XML'
        ...
        yield 'Sorts Attributes with Custom Order' => [<<<'XML'
        ...
        yield 'Does Not Change Order of Already Sorted Attributes' => [<<<'XML'
        ...
        yield 'Sorts Multiple Attributes Alphabetically' => [<<<'XML'
        ...
        yield 'Sorts Attributes Inside Groups Correctly' => [<<<'XML'
        ...
        yield 'Handles Attributes with Different Prefixes Correctly' => [<<<'XML'
