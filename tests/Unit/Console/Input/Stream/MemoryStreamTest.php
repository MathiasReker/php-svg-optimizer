...
final class MemoryStreamTest extends TestCase
{
    ...
    public function testConstructorThrowsIfStreamFails(): void
    {
        ...
        // Then forcibly call the code that would throw,
        // e.g., some init method or do the test on a method that uses $stream.
        // Since the constructor is not run, simulate failure by throwing manually:
    ...
    public function testGetContentsThrowsIfReadingFails(): void
    {
        ...
        $mock->method('getContents')->willReturnCallback(
