...
[![Type Coverage](https://img.shields.io/badge/TypeCoverage-100%25-brightgreen)](https://github.com/shepherdkit/php-type-coverage)
...
|---------|------|--------------------------------------------------------------|
| ^7.0    | ^8.3 | [current](https://github.com/MathiasReker/php-svg-optimizer) |
